            ...
            <div>
                ...
                <div onClick={() => { this.handleModal() }} className="movie_card" key={this.props.movie.id} id={this.props.movie.id}>
                    ...
                    <div className="movie_info">
                        ...
                        <p className="release_date"> | {this.props.movie.release_date !== 'undifined' ? this.props.movie.release_date.substring(0,4) : this.props.movie.first_air_date.substring(0,4)}</p>
                    </div>
                </div>
            </div>
        )
